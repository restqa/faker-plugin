...
#The following step is not a part of the plugin it is just showing an example of usage
Then my fake value is accessible through {{ lastName }} #This step is not a part of the plugin

Scenario: Generate fake value (minimalist)
Given fake locale = "cz"
  And fake data "animal.bird" => "birdName"
#The following step is not a part of the plugin it is just showing an example of usage
Then my fake value is accessible through "{{ birdName }}" #This step is not a part of the plugin

Scenario: Generate fake value (data on the fly)
Given fake locale = "cz"
#The following step is not a part of the plugin it is just showing an example of usage
Then my fake value is accessible through {{ faker.animal.bird }} # This step is not a part of the plugin
