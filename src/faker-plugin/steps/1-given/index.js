...
module.exports = [
  ...
  /**
    ...
    * @function locale
    */
  ['I use the {string} language to generate fake data', given.locale, 'Define the local to user for the fake data', 'faker, locale'],
  ['I use the {data} language to generate fake data', given.locale, 'Define the local to user for the fake data', 'faker, locale, data'],
  ['fake locale = {string}', given.locale, 'Define the local to user for the fake data', 'faker, locale, minimalist, data'],
  ...
  /**
    ...
    */
  ['I generate a fake data for {string} and store it into the dataset as {string}', given.defineVariable, 'Store a fake data into the dataset', 'faker, dataset, variable'],
  ['fake data {string} => {string}', given.defineVariable, 'Store a fake data into the dataset', 'faker, dataset, variable']
]
